...
@section('title', 'Cestino Linguaggi')

@section('content')
    <section id="trash-technologies">
      <div class="d-flex align-items-center justify-content-between">
        ...
        <h1 class="my-4">Linguaggi eliminati</h1>
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex justify-content-end align-items-center gap-2">
                        ...
                        <form action="{{route('admin.technologies.restore', $technology->id)}}" method="POST" class="restore-form">
                          @csrf
                          @method('PATCH')
                          <button class="btn btn-sm btn-success"><i class="fas fa-arrows-rotate"></i></button>
                      </form>
                        <form action="{{route('admin.technologies.drop', $technology->id)}}" method="POST" class="delete-form">
                            @csrf
                            @method('DELETE')
